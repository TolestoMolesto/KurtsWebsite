...
export const ITEMS: Item[] = [
    // --- CURIOS ---
    { id: 'meditation', name: 'Meditation', cost: 0, type: 'Curio', category: 'Utility', stats: { Cooldown: '140s' }, image: getItemImage(1), passive: 'ACTIVE: You and allies within 6.4m gain +10 (+2.5% missing HP) Heal/s and +10 (+3% missing Mana) Mana/s for 4s.' },
    { id: 'heimdallrs-sight', name: 'Heimdallr\'s Sight', cost: 0, type: 'Curio', category: 'Utility', stats: { Cooldown: '90s' }, image: getItemImage(2), passive: 'ACTIVE: Pulse reveal area 4 times over 4s. Reveals enemies/stealth within 8.8m.' },
    { id: 'gjallarflare', name: 'Gjallarflare', cost: 0, type: 'Curio', category: 'Utility', stats: { Cooldown: '120s' }, image: getItemImage(3), passive: 'ACTIVE: Fire flare revealing enemies within 8.8m. Detonate to reveal 13.2m area.' },
    { id: 'bifrost-shard', name: 'Bifrost Shard', cost: 0, type: 'Curio', category: 'Utility', stats: { Cooldown: '90s' }, image: getItemImage(4), passive: 'ACTIVE: Place a Ward. Reveals 7.2m. Lasts 90s.' },
    { id: 'battle-cry', name: 'Battle Cry', cost: 0, type: 'Curio', category: 'Utility', stats: { Cooldown: '120s' }, image: getItemImage(5), passive: 'ACTIVE: Consume stacks (gained on kill) to buff stats +3% per stack.' },

    // --- RELICS ---
    { id: 'beads', name: 'Purification Beads', cost: 0, type: 'Relic', category: 'Defense', stats: { Cooldown: '150s' }, image: getItemImage(6), passive: 'ACTIVE: Immune to Crowd Control for 2s.' },
    { id: 'aegis', name: 'Aegis of Acceleration', cost: 0, type: 'Relic', category: 'Defense', stats: { Cooldown: '140s' }, image: getItemImage(7), passive: 'ACTIVE: Immune to damage/healing 1.5s. Gain Speed on dmg prevented.' },
    { id: 'blink', name: 'Blink Rune', cost: 0, type: 'Relic', category: 'Utility', stats: { Cooldown: '140s' }, image: getItemImage(8), passive: 'ACTIVE: Teleport 5.6m. Cannot use in combat (3s). Kills reduce CD.' },
    { id: 'phantom', name: 'Phantom Shell', cost: 0, type: 'Relic', category: 'Defense', stats: { Cooldown: '120s' }, image: getItemImage(9), passive: 'ACTIVE: Shield self/allies +100 (+10/lvl). Pass through walls. Take less dmg.' },
    { id: 'sundering', name: 'Sundering Arc', cost: 0, type: 'Relic', category: 'Offense', stats: { Cooldown: '120s' }, image: getItemImage(10), passive: 'ACTIVE: Deal True Dmg to Jungle (High). Bleed Gods for True Dmg.' },
    { id: 'agility', name: 'Agility Relic', cost: 0, type: 'Relic', category: 'Utility', stats: { Cooldown: '20s' }, image: getItemImage(11), passive: 'ACTIVE: Dash. Passive: Ranged +40% Proj Speed, Melee -15% Atk Move Penalty.' },
    ...
    // --- TIER 1 STARTERS ---
    { id: 'selflessness', name: 'Selflessness', cost: 550, tier: 1, type: 'Starter', category: 'Defense', stats: { 'Phys. Prot': '10', 'Mag. Prot': '10', 'Max Health': '60' }, image: getItemImage(100), passive: 'Assist: Bonus Gold/Heal. Ally CC\'d: Shield them.' },
    { id: 'war-flag', name: 'War Flag', cost: 550, tier: 1, type: 'Starter', category: 'Utility', stats: { 'Phys. Prot': '10', 'Mag. Prot': '10', 'Max Health': '60' }, image: getItemImage(101), passive: 'Assist: Gold/Heal/Mana. Allies gain Move/Atk Speed.' },
    { id: 'bumbas-cudgel', name: 'Bumba\'s Cudgel', cost: 650, tier: 1, type: 'Starter', category: 'Offense', stats: { 'Max Health': '75', 'Max Mana': '50', 'Adaptive': '15|20' }, image: getItemImage(102), passive: '+50% Dmg to Jungle. Heal on Jungle kill.' },
    { id: 'warriors-axe', name: 'Warrior\'s Axe', cost: 650, tier: 1, type: 'Starter', category: 'Defense', stats: { 'Strength': '12', 'Phys. Prot': '10', 'Mag. Prot': '10' }, image: getItemImage(103), passive: 'Damage God: Steal 30 Health/Mana + True Dmg. CD 8s.' },
    { id: 'bluestone', name: 'Bluestone Pendant', cost: 650, tier: 1, type: 'Starter', category: 'Offense', stats: { 'Strength': '15', 'HP5': '2.5', 'MP5': '2' }, image: getItemImage(104), passive: 'Abilities deal bonus Physical DoT.' },
    { id: 'gilded-arrow', name: 'Gilded Arrow', cost: 650, tier: 1, type: 'Starter', category: 'Offense', stats: { 'Atk Speed': '10%', 'Basic Dmg': '20' }, image: getItemImage(105), passive: 'Mark Minion. Kill for bonus Gold/Atk Speed.' },
    { id: 'bumbas-dagger', name: 'Bumba\'s Golden Dagger', cost: 650, tier: 1, type: 'Starter', category: 'Offense', stats: { 'Max Health': '50', 'Atk Speed': '10%', 'Adaptive': '15|20' }, image: getItemImage(106), passive: 'Jungle Dmg + Cleave Basics.' },
    { id: 'leather-cowl', name: 'Leather Cowl', cost: 650, tier: 1, type: 'Starter', category: 'Offense', stats: { 'Strength': '15', 'Lifesteal': '4%' }, image: getItemImage(107), passive: 'Near Ally: Atk Speed. Alone: Move Speed.' },
    { id: 'sands-time', name: 'Sands of Time', cost: 650, tier: 1, type: 'Starter', category: 'Utility', stats: { 'Intelligence': '25', 'MP5': '2', 'Cooldown': '10' }, image: getItemImage(108), passive: 'Mana Regen increases with missing Mana.' },
    { id: 'vampiric', name: 'Vampiric Shroud', cost: 650, tier: 1, type: 'Starter', category: 'Offense', stats: { 'Intelligence': '20', 'Max Health': '100' }, image: getItemImage(109), passive: 'Ability Hit: Restore Health/Mana.' },
    { id: 'conduit', name: 'Conduit Gem', cost: 650, tier: 1, type: 'Starter', category: 'Offense', stats: { 'Intelligence': '30', 'Max Mana': '100', 'MP5': '1' }, image: getItemImage(110), passive: 'Gain stacks. Abilities deal bonus True Dmg per stack.' },
    { id: 'deaths-toll', name: 'Death\'s Toll', cost: 650, tier: 1, type: 'Starter', category: 'Offense', stats: { 'Strength': '15', 'Max Health': '100' }, image: getItemImage(111), passive: 'Basics restore Health/Mana.' },

    // --- TIER 2 STARTERS (UPGRADED) ---
    { id: 'heroism', name: 'Heroism', cost: 1800, tier: 2, type: 'Starter', category: 'Defense', stats: { 'Phys. Prot': '30', 'Mag. Prot': '30', 'Max Health': '200' }, image: getItemImage(112), passive: 'Ally Hard CC: Shield them (50+10% HP).', buildsFrom: ['selflessness'] },
    { id: 'war-banner', name: 'War Banner', cost: 1800, tier: 2, type: 'Starter', category: 'Utility', stats: { 'Phys. Prot': '30', 'Mag. Prot': '30', 'Max Health': '200' }, image: getItemImage(113), passive: 'Assist: Buff team Move/Atk Speed.', buildsFrom: ['war-flag'] },
    { id: 'sundering-axe', name: 'Sundering Axe', cost: 2150, tier: 2, type: 'Starter', category: 'Defense', stats: { 'Strength': '30', 'Phys. Prot': '30', 'Mag. Prot': '30' }, image: getItemImage(114), passive: 'Dmg God: Steal Health + Bonus True Dmg.', buildsFrom: ['warriors-axe'] },
    { id: 'bluestone-brooch', name: 'Bluestone Brooch', cost: 2150, tier: 2, type: 'Starter', category: 'Offense', stats: { 'Strength': '30', 'Max Health': '200', 'HP5': '7', 'MP5': '5' }, image: getItemImage(115), passive: 'Abilities deal % Current HP Dmg.', buildsFrom: ['bluestone'] },
    { id: 'sharpshooter', name: 'Sharpshooter\'s Arrow', cost: 2150, tier: 2, type: 'Starter', category: 'Offense', stats: { 'Basic Power': '40', 'Atk Speed': '15%', 'Crit Chance': '15%' }, image: getItemImage(116), passive: 'Gold Gain. +Atk Dmg to far targets.', buildsFrom: ['gilded-arrow'] },
    { id: 'bumbas-spear', name: 'Bumba\'s Spear', cost: 2150, tier: 2, type: 'Starter', category: 'Offense', stats: { 'Max Health': '200', 'Atk Speed': '25%', 'Adaptive': '35|60' }, image: getItemImage(117), passive: 'Jungle Dmg. Kill Jungle: +Power.', buildsFrom: ['bumbas-cudgel'] },
    { id: 'bumbas-hammer', name: 'Bumba\'s Hammer', cost: 2150, tier: 2, type: 'Starter', category: 'Offense', stats: { 'Max Health': '200', 'Cooldown': '10', 'Adaptive': '35|60' }, image: getItemImage(118), passive: 'Ability -> Basic: True Dmg + CD Reduction + Heal.', buildsFrom: ['bumbas-cudgel'] },
    { id: 'hunters-cowl', name: 'Hunter\'s Cowl', cost: 2150, tier: 2, type: 'Starter', category: 'Offense', stats: { 'Strength': '45', 'Lifesteal': '5%' }, image: getItemImage(119), passive: 'Aura: Atk Speed/Lifesteal. Alone: Move Speed.', buildsFrom: ['leather-cowl'] },
    { id: 'deaths-embrace', name: 'Death\'s Embrace', cost: 2150, tier: 2, type: 'Starter', category: 'Offense', stats: { 'Strength': '40', 'Max Health': '150', 'Lifesteal': '5%' }, image: getItemImage(120), passive: 'Basics restore % Health/Mana. Reduce CD.', buildsFrom: ['deaths-toll'] },
    { id: 'pendulum', name: 'Pendulum of Ages', cost: 2150, tier: 2, type: 'Starter', category: 'Utility', stats: { 'Intelligence': '70', 'MP5': '4', 'Cooldown': '20' }, image: getItemImage(121), passive: 'MP5 per missing Mana. Int per Mana.', buildsFrom: ['sands-time'] },
    { id: 'archmage', name: 'Archmage\'s Gem', cost: 2150, tier: 2, type: 'Starter', category: 'Offense', stats: { 'Intelligence': '90', 'Max Mana': '150', 'MP5': '4' }, image: getItemImage(122), passive: 'Ability Hit: Bonus % Int Dmg (CD 20s).', buildsFrom: ['conduit'] },
    { id: 'blood-shroud', name: 'Blood-soaked Shroud', cost: 2150, tier: 2, type: 'Starter', category: 'Offense', stats: { 'Intelligence': '60', 'Max Health': '275' }, image: getItemImage(123), passive: 'Ability Hit: Heal %HP/Mana. Heal increases with kills.', buildsFrom: ['vampiric'] },
