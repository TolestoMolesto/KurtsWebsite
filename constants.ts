...
export const ITEMS: Item[] = [
    ...
    { id: 'gem-of-focus', name: 'Gem of Focus', cost: 2350, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '50', 'Cooldown Rate': '20%' }, image: 'https://image2url.com/images/1764397646139-4c9df457-14b4-4684-8da4-b57bbbd02792.png', passive: 'Ability Used: Gain a stack of Momentum. Momentum grants +4% Movement Speed for 6s. Stacks up to 3 times.', buildsFrom: ['killing-stone', 'adroit-ring' ] },
    { id: 'chronos-pendant', name: "Chronos' Pendant", cost: 2400, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '55', 'Cooldown Rate': '25%' }, image: 'https://image2url.com/images/1764397707141-be1256dd-6a0b-4ad2-88b3-58247e57fa2e.png', passive: 'Every 10s: -1s Ability Cooldowns.', buildsFrom: ['ring-dispel', 'adroit-ring' ] },
    { id: 'jotunns-revenge', name: "Jotunn's Revenge", cost: 2400, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '40', 'Cooldown Rate': '25%' }, image: 'https://image2url.com/images/1764397263710-ba2e0911-ab69-481d-bd8b-5fe811c9f9f0.png', passive: 'God Kill or Assist: -1s Cooldown for Non-Ultimate Abilities, -5s Cooldown for Ultimate Abilities.', buildsFrom: ['skeggox', 'caestus' ] },
    { id: 'dagger-of-frenzy', name: 'Dagger of Frenzy', cost: 2400, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '35', 'Attack Speed': '10%' }, image: 'https://image2url.com/images/1764397559320-8d795b1b-2343-43f1-9d82-b3f21ef0dd27.png', passive: 'On Use: +10 (+4 per Level) Attack Damage, +50% Attack Speed. Buff lasts 6s. Cooldown: 15s. Killing a God refreshes Cooldown.', buildsFrom: ['manchu-bow', 'skeggox' ] },
