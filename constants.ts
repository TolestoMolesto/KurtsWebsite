...
export const ITEMS: Item[] = [
    ...
    { id: 'blood-bound-book', name: 'Blood-Bound Book', cost: 2250, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '60', 'Lifesteal': '7.5%' }, image: getItemImage('blood-bound-book'), passive: 'On Use: +Health Shield for 6s. Shield = 7.5% Max Health & 75% Intelligence from items. While Shielded: +10% Lifesteal. Cooldown: 80s. Kill a God: -25% Cooldown.', buildsFrom: ['cursed-sickle', 'killing-stone' ] },
    { id: 'book-of-thoth', name: 'Book of Thoth', cost: 2300, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '30', 'Max Mana': '200', 'Mana Regen': '4' }, image: getItemImage('book-of-thoth'), passive: '+Intelligence equal to 5% of Mana from items. Deal 900 Damage to Minions or Jungle Monsters: +1 Stack. Damage dealt to Gods counts double. Per Stack: +10 Mana. At 50 Stacks, item evolves and gains: Additional +Intelligence equal to 2% of Mana from Items, +20 Intelligence, +100 Mana.' },
    { id: 'eros-bow', name: "Eros' Bow", cost: 2300, tier: 3, type: 'Item', category: 'Offense', stats: { 'Max Health': '300', 'Attack Speed': '30%' }, image: getItemImage('eros-bow'), passive: 'On Use: Mark an ally god. Only one ally may be Marked at a time. Mark breaks if ally is more than 20m away. On Attack Hit: Heal the Marked ally for +1.5% of your Max Health. Cooldown: 1s.' },
    { id: 'bancrofts-talon', name: "Bancroft's Talon", cost: 2300, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '55', 'Max Mana': '150', 'Mana Regen': '2', 'Lifesteal': '7.5%' }, image: getItemImage('bancrofts-talon'), passive: 'Gain bonus Intelligence and Lifesteal scaled from missing Health. Caps at +60 Intelligence and +10% Lifesteal at 40% Health.' },
    { id: 'gem-of-focus', name: 'Gem of Focus', cost: 2350, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '50', 'Cooldown Rate': '20%' }, image: getItemImage('gem-of-focus'), passive: 'Ability Used: Gain a stack of Momentum. Momentum grants +4% Movement Speed for 6s. Stacks up to 3 times.' },
    { id: 'chronos-pendant', name: "Chronos' Pendant", cost: 2400, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '55', 'Cooldown Rate': '25%' }, image: getItemImage('chronos-pendant'), passive: 'Every 10s: -1s Ability Cooldowns.' },
    { id: 'jotunns-revenge', name: "Jotunn's Revenge", cost: 2400, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '40', 'Cooldown Rate': '25%' }, image: getItemImage('jotunns-revenge'), passive: 'God Kill or Assist: -1s Cooldown for Non-Ultimate Abilities, -5s Cooldown for Ultimate Abilities.' },
    { id: 'dagger-of-frenzy', name: 'Dagger of Frenzy', cost: 2400, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '35', 'Attack Speed': '10%' }, image: getItemImage('dagger-of-frenzy'), passive: 'On Use: +10 (+4 per Level) Attack Damage, +50% Attack Speed. Buff lasts 6s. Cooldown: 15s. Killing a God refreshes Cooldown.' },
    ...
    { id: 'transcendence', name: 'Transcendence', cost: 2400, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '35', 'Max Mana': '400', 'Mana Regen': '4' }, image: getItemImage('transcendence'), passive: '+Strength equal to 3% of Mana from Items. Deal 700 Damage to Minions or Jungle Monsters: +1 Stack. Damage dealt to Gods counts double. Per Stack: +7 Mana. At 50 Stacks, item evolves and gains: +15 Strength, +100 Mana.' },
    ...
    { id: 'hydras-lament', name: "Hydra's Lament", cost: 2450, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '45', 'Max Mana': '200', 'Mana Regen': '4', 'Cooldown Rate': '10%' }, image: getItemImage('hydras-lament'), passive: 'Ability Used: +30% Damage on your next Attack. Buff lasts 8s.' },
    { id: 'rage', name: 'Rage', cost: 2450, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '30', 'Critical Chance': '20%' }, image: getItemImage('rage'), passive: 'God Kill or Assist: +4% Critical Strike Chance (Max 20%). After 5 God Kills or Assists: +10% additional Critical Strike Chance.' },
    ...
    { id: 'bracer-of-the-abyss', name: 'Bracer of The Abyss', cost: 2500, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '45', 'Attack Speed': '30%' }, image: getItemImage('bracer-of-the-abyss'), passive: 'Hit enemy Gods or Jungle Bosses: +10 Attack Damage for 10s. Stacks up to 8 times.' },
    ...
    { id: 'nimble-ring', name: 'Nimble Ring', cost: 2500, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '35', 'Attack Speed': '20%', 'Lifesteal': '7.5%' }, image: getItemImage('nimble-ring'), passive: 'For every 10 Intelligence: +1 Attack Damage, +1% Attack Speed.' },
    ...
    { id: 'polynomicon', name: 'Polynomicon', cost: 2550, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '75', 'Max Mana': '200', 'Mana Regen': '3' }, image: getItemImage('polynomicon'), passive: 'Ability Used: Your next Attack deals bonus Magical Damage. Damage = 60% of your Intelligence.' },
    { id: 'bloodforge', name: 'Bloodforge', cost: 2550, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '45', 'Lifesteal': '7.5%' }, image: getItemImage('bloodforge'), passive: 'On Use: +Health Shield for 6s. Shield = 10% Max Health & 150% Strength from Items. While Shielded: +10% Lifesteal. Cooldown: 80s. Kill a God: -25% Cooldown.' },
    { id: 'oath-sworn-spear', name: 'Oath-Sworn Spear', cost: 2550, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '60' }, image: getItemImage('oath-sworn-spear'), passive: 'Ability Hit: Target is -1 Physical Protection per your Level for 4s.' },
    { id: 'bragis-harp', name: "Bragi's Harp", cost: 2550, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '35', 'Intelligence': '25', 'Attack Speed': '10%' }, image: getItemImage('bragis-harp'), passive: 'Attack Hit: +10 (+3 per Level) bonus Magical Damage. Structures and Bosses take half damage from Bragi\'s Harp.' },
    { id: 'necronomicon', name: 'Necronomicon', cost: 2550, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '50', 'Max Mana': '300', 'Mana Regen': '5' }, image: getItemImage('necronomicon'), passive: 'God Kill or Assist: +1 Stack of: +30 Intelligence. Stacks up to 6 times. On Death: Lose 4 Stacks.' },
    ...
    { id: 'the-reaper', name: 'The Reaper', cost: 2600, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '65', 'Lifesteal': '10%' }, image: getItemImage('the-reaper'), passive: 'Kill a God: Heal +15% of Slain God\'s Max Health. Assist a God: Heal +7.5% of Slain God\'s Max Health. During Moonlight Phase: Heal +15% of Slain God\'s Max Health, on Kill or Assist.' },
    ...
    { id: 'ancient-signet', name: 'Ancient Signet', cost: 2600, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '80', 'Max Mana': '250' }, image: getItemImage('ancient-signet'), passive: 'Ability Hit: +20 (+12 per Level) bonus Magical Damage. Cooldown: 15s. -2s Cooldown for each minion kill or assist.' },
    ...
    { id: 'death-metal', name: 'Death Metal', cost: 2600, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '35', 'Intelligence': '40', 'Critical Chance': '15%' }, image: getItemImage('death-metal'), passive: 'On Use: You and Allies within 6.4m gain: +25% Crit Chance, +25% Attack Speed. Buff lasts 6s. Cooldown: 45s.' },
    { id: 'tyrfing', name: 'Tyrfing', cost: 2600, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '45', 'Attack Speed': '10%' }, image: getItemImage('tyrfing'), passive: 'Attacks deal +15 bonus Physical Damage. On God hit: Increase bonus Damage by +15 for 4s. Stacks once, +1 Stack per 4 Levels (Max 6 Stacks).' },
    { id: 'the-cosmic-horror', name: 'The Cosmic Horror', cost: 2650, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '85', 'Max Mana': '200', 'Mana Regen': '3', 'Cooldown Rate': '10%' }, image: getItemImage('the-cosmic-horror'), passive: 'Have 275+ Item Intelligence: +10 Cooldown Rate.' },
    { id: 'hastened-fatalis', name: 'Hastened Fatalis', cost: 2650, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '20', 'Attack Speed': '25%' }, image: getItemImage('hastened-fatalis'), passive: 'Attack Hits a God: -12.5% Attack Movement Penalty. Melee hits grants 2 Stacks. Stacks up to 4 times. Buff lasts 2s.' },
    ...
    { id: 'spear-of-desolation', name: 'Spear of Desolation', cost: 2650, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '100', 'Cooldown Rate': '10%' }, image: getItemImage('spear-of-desolation'), passive: 'God Kill or Assist: -3s Non Ultimate Cooldowns, -10s Ultimate Cooldowns.' },
    ...
    { id: 'riptalon', name: 'Riptalon', cost: 2700, tier: 3, type: 'Item', category: 'Offense', stats: { 'Attack Speed': '20%', 'Lifesteal': '7.5%', 'Basic Attack Power': '25%' }, image: getItemImage('riptalon'), passive: 'While Above 50% Health: +10% Attack Damage. While Below 50% Health: +25% Attack Damage, +7.5% Lifesteal.' },
    { id: 'musashis-dual-swords', name: "Musashi's Dual Swords", cost: 2700, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '35', 'Critical Chance': '30%' }, image: getItemImage('musashis-dual-swords'), passive: 'Critically Strike: +15% Movement Speed for 5s.' },
    { id: 'tekko-kagi', name: 'Tekko-Kagi', cost: 2700, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '60', 'Cooldown Rate': '10%' }, image: getItemImage('tekko-kagi'), passive: 'Ability Used: Gain a stack of Momentum. Momentum grants +4% Movement Speed for 6s. Stacks up to 3 times.' },
    { id: 'doom-orb', name: 'Doom Orb', cost: 2700, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '90', 'Max Mana': '200', 'Mana Regen': '2' }, image: getItemImage('doom-orb'), passive: 'Kill or Assist a Minion: +1 Stack. Kill or Assist a God: +5 Stacks. Per Stack: +8 Intelligence. Max 5 Stacks. Stacks last 10s. Stacks fall off one at a time.' },
    { id: 'jade-scepter', name: 'Jade Scepter', cost: 2750, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Intelligence': '90', 'Max Health': '150' }, image: getItemImage('jade-scepter'), passive: 'On Use: Displace enemy Gods in front of you, pushing them away. Cooldown: 60s.' },
    { id: 'demon-blade', name: 'Demon Blade', cost: 2750, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '30', 'Attack Speed': '15%', 'Critical Chance': '15%' }, image: getItemImage('demon-blade'), passive: 'Critically Strike: +30% Attack Speed for 3s.' },
    { id: 'staff-of-myrddin', name: 'Staff of Myrddin', cost: 2750, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '70', 'Cooldown Rate': '10%' }, image: getItemImage('staff-of-myrddin'), passive: 'On Use: Next non-Ultimate Ability used will have no cooldown. Cooldown: 80s.' },
    { id: 'the-crusher', name: 'The Crusher', cost: 2800, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '60', 'Cooldown Rate': '15%' }, image: getItemImage('the-crusher'), passive: 'Ability Hit: +Physical Damage. Damage = 35% of your Strength. Damage is dealt over 1s. Subsequent hits on the same target deal 50% bonus Damage, over 3s.' },
    { id: 'totem-of-death', name: 'Totem of Death', cost: 2800, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '60', 'Cooldown Rate': '15%' }, image: getItemImage('totem-of-death'), passive: 'Ability Hit a God or Boss: Apply 1 Stack of Piercing. Piercing reduces 6% Protections for 4s. Stacks up to 5 times.' },
    { id: 'the-world-stone', name: 'The World Stone', cost: 2800, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '70', 'Max Mana': '250', 'Mana Regen': '3' }, image: getItemImage('the-world-stone'), passive: '-30% Cooldown for your Ultimate Ability.' },
    { id: 'pendulum-blade', name: 'Pendulum Blade', cost: 2800, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '45', 'Cooldown Rate': '10%' }, image: getItemImage('pendulum-blade'), passive: 'On Use: -4s Ability Cooldowns. Cooldown: 40s.' },
    { id: 'deathbringer', name: 'Deathbringer', cost: 2900, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '45', 'Critical Chance': '20%' }, image: getItemImage('deathbringer'), passive: '+35% Critical Strike Damage.' },
    ...
    { id: 'heartseeker', name: 'Heartseeker', cost: 3000, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '55', 'Max Mana': '250', 'Mana Regen': '2' }, image: getItemImage('heartseeker'), passive: 'Ability Hit: +%Health Physical Damage. Damage = 2.5% of your Strength, as a % of the target\'s Max Health.' },
    { id: 'rod-of-tahuti', name: 'Rod of Tahuti', cost: 3000, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '85', 'Max Mana': '250', 'Mana Regen': '2' }, image: getItemImage('rod-of-tahuti'), passive: '+Intelligence equal to 25% of your Intelligence from items.' },
    { id: 'obsidian-shard', name: 'Obsidian Shard', cost: 3050, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '60' }, image: getItemImage('obsidian-shard'), passive: 'Gain the Shattering effect: +35% Penetration. Does not stack with itself.' },
    { id: 'titans-bane', name: "Titan's Bane", cost: 3100, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '50' }, image: getItemImage('titans-bane'), passive: 'Gain the Shattering effect: +35% Penetration. Does not stack with itself.' },
    { id: 'dreamers-idol', name: "Dreamer's Idol", cost: 3500, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '140' }, image: getItemImage('dreamers-idol'), passive: 'On Use: +25% Intelligence, Become Immune to Displacement. Buff lasts 10s. Cooldown: 120s.' },
    { id: 'avatars-parashu', name: "Avatar's Parashu", cost: 3700, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '100' }, image: getItemImage('avatars-parashu'), passive: 'On Use: +25% Strength and Immune to Displacement for 10s. Cooldown: 120s.' },
    ...
    { id: 'gauntlet-of-thebes', name: "Gauntlet of Thebes", cost: 2200, tier: 3, type: 'Item', category: 'Defense', stats: { 'Max Health': '200', 'Max Mana': '150' }, image: getItemImage('gauntlet-of-thebes'), passive: 'Assist a Minion: +1 Stack. God Kill or Assist: +5 Stacks. Stacks grant +15 Max Health (max 40 Stacks). At 40 Stacks, Item evolves: +200 Max Health.' },
		{ id: 'yogis-necklace', name: "Yogi's Necklace", cost: 2250, tier: 3, type: 'Item', category: 'Defense', stats: { 'Max Health': '400', 'Max Mana': '250', 'Health Regen': '6', 'Mana Regen': '6' }, image: getItemImage('yogis-necklace'), passive: 'Heal +0.5% of your Max Health per second.' },
		...
		{ id: 'eye-of-providence', name: "Eye of Providence", cost: 2300, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '25', 'Magical Protection': '25', 'Max Health': '250' }, image: getItemImage('eye-of-providence'), passive: 'Destroy a Ward: +50 Gold. On Use: Place a Ward. Reveals enemies and enemy wards within 7.2m. Lasts 120s or until destroyed. Cooldown: 60s. (Max 2 Wards can be Placed) You can own up to 3 active items at once.' },
		{ id: 'spectral-armor', name: "Spectral Armor", cost: 2300, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '30', 'Max Health': '400' }, image: getItemImage('spectral-armor'), passive: 'Enemies within 8.8m: -25% Attack Speed, Deal -25% Damage with Critical Strikes.' },
		...
		{ id: 'genjis-guard', name: "Genji's Guard", cost: 2350, tier: 3, type: 'Item', category: 'Defense', stats: { 'Magical Protection': '50', 'Max Mana': '200', 'Mana Regen': '5', 'Cooldown Rate': '15' }, image: getItemImage('genjis-guard'), passive: 'Hit by Magical Ability Damage: -3s Cooldowns. Cooldown: 15s.' },
		{ id: 'erosion', name: "Erosion", cost: 2400, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '30', 'Magical Protection': '20', 'Max Health': '250' }, image: getItemImage('erosion'), passive: '-30% Shields applied to enemy Gods within 11.2m. When this occurs: +10% of your Physical and Magical Protections for 6s. Can stack up to 2 times.' },
		{ id: 'shield-of-the-phoenix', name: "Shield of the Phoenix", cost: 2400, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '15', 'Max Health': '225', 'Cooldown Rate': '10' }, image: getItemImage('shield-of-the-phoenix'), passive: 'Ability Hit a God: +1.5% Health Heal, +2% Mana Restore. Triggers once per Ability, per God hit.' },
		...
		{ id: 'breastplate-of-valor', name: "Breastplate of Valor", cost: 2400, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '35', 'Max Mana': '200', 'Mana Regen': '2', 'Cooldown Rate': '20' }, image: getItemImage('breastplate-of-valor'), passive: 'Lose 500 (+25 per Level) Health: -1s Ability Cooldowns. 25% of Self-Healing from Abilities counts towards the lost health trigger.' },
		{ id: 'magis-cloak', name: "Magi's Cloak", cost: 2400, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '35', 'Magical Protection': '35' }, image: getItemImage('magis-cloak'), passive: 'Every 90s: Gain a Hard Crowd Control protective bubble. When triggered, gain Crowd Control Immunity for 1.5s.' },
    { id: 'screeching-gargoyle', name: "Screeching Gargoyle", cost: 2400, tier: 3, type: 'Item', category: 'Defense', stats: { 'Magical Protection': '50', 'Cooldown Rate': '15' }, image: getItemImage('screeching-gargoyle'), passive: 'On Use: Enemies in front of you: Silenced for 1s, -10% Protections for 4s. Cooldown: 90s. During Moonlight Phase: Hits enemies around you, Silence lasts 1.5s, -15% Protections. You can own up to 3 active items at once.' },
		{ id: 'phoenix-feather', name: "Phoenix Feather", cost: 2400, tier: 3, type: 'Item', category: 'Defense', stats: { 'Magical Protection': '35', 'Max Health': '300' }, image: getItemImage('phoenix-feather'), passive: 'On Use: Fire 3 Pulses that Heal you and True Damage enemies within 3.2m. Heal = +75 Health +7.5 Missing Health. True Damage = +3% Max Health from Items. Cooldown: 120s. You can own up to 3 active items at once.' },
		{ id: 'prophetic-cloak', name: "Prophetic Cloak", cost: 2400, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '22', 'Magical Protection': '22', 'Cooldown Rate': '10' }, image: getItemImage('prophetic-cloak'), passive: 'Damage a God: +1 Protection Stack against the damage type they deal. Cooldown: 5s. At +20 of each Protection Stack, item evolves: +5 Physical Protection and Magical Protection, +6% Damage Mitigation (or +12% if total Protections > 300).' },
		{ id: 'stampede', name: "Stampede", cost: 2400, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '30', 'Max Health': '250', 'Health Regen': '5' }, image: getItemImage('stampede'), passive: 'On Use: You and allies within 6.4m gain: Slow Immunity, +60% Movement Speed that decays to +20% over 4s. Cooldown: 90s. You can own up to 3 active items at once.' },
		...
		{ id: 'pharaohs-curse', name: "Pharaoh's Curse", cost: 2450, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '35', 'Magical Protection': '25', 'Attack Speed': '15%' }, image: getItemImage('pharaohs-curse'), passive: 'On Use: Enemies within 5.6m: -50% Shields, -20% Movement Speed, -40% Attack Speed. Debuff lasts 4s. Cooldown: 45s. You can own up to 3 active items at once.' },
		{ id: 'gladiators-shield', name: "Gladiator's Shield", cost: 2450, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '25', 'Max Health': '200', 'Cooldown Rate': '10' }, image: getItemImage('gladiators-shield'), passive: 'Abilities deal bonus Physical Damage. Damage = +10 + 40 of your Item Protections. Triggers once per Ability Cast, per God.' },
		{ id: 'umbral-link', name: "Umbral Link", cost: 2500, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '40', 'Lifesteal': '10%' }, image: getItemImage('umbral-link'), passive: 'Above 50% Health: Split your Lifesteal Healing with allies within 11.2m. +10 Physical and Magical Protections for 8s per unique ally Healed.' },
		{ id: 'shoguns-ofuda', name: "Shogun's Ofuda", cost: 2500, tier: 3, type: 'Item', category: 'Defense', stats: { 'Magical Protection': '30', 'Max Health': '200', 'Attack Speed': '15%' }, image: getItemImage('shoguns-ofuda'), passive: '+20% Attack Speed for you and allies within 8.8m.' },
		{ id: 'ancile', name: "Ancile", cost: 2500, tier: 3, type: 'Item', category: 'Defense', stats: { 'Magical Protection': '45', 'Max Health': '250' }, image: getItemImage('ancile'), passive: '-10% Attack Damage taken. On Use: Your next Ability that damages a god Silences them for 1.5s. Cooldown: 70s. Take Attack Damage: -2s Item Cooldown. You can own up to 3 active items at once.' },
		{ id: 'spirit-robe', name: "Spirit Robe", cost: 2500, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '25', 'Magical Protection': '25' }, image: getItemImage('spirit-robe'), passive: 'Hit by Hard Crowd Control: +40 Physical Protection, +40 Magical Protection, +4% Health Heal over time. Buff lasts 6s.' },
		{ id: 'oni-hunters-garb', name: "Oni Hunter's Garb", cost: 2500, tier: 3, type: 'Item', category: 'Defense', stats: { 'Magical Protection': '40', 'Max Health': '150', 'Max Mana': '200', 'Mana Regen': '8' }, image: getItemImage('oni-hunters-garb'), passive: 'For each enemy god within 8.8m: +4% Damage Mitigation. Max 3 stacks.' },
    { id: 'leviathans-hide', name: "Leviathan's Hide", cost: 2500, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '40', 'Max Health': '250' }, image: getItemImage('leviathans-hide'), passive: 'Damaged by God Attack: That God is -10% Strength & Attack Damage for 4s. Attack an Enemy God: +8 Max Health Permanently. Cooldown: 10s. Damaged by Enemy God: -0.5s once per Ability Cast or Attack.' },
		{ id: 'talisman-of-purification', name: "Talisman of Purification", cost: 2500, tier: 3, type: 'Item', category: 'Defense', stats: { 'Magical Protection': '30', 'Max Health': '300', 'Cooldown Rate': '10' }, image: getItemImage('talisman-of-purification'), passive: 'On Use: You and Allies within 6.4m: Are Cleansed of all Crowd Control, Gain Crowd Control Immunity for 1s. Cooldown: 140s. You can own up to 3 active items at once.' },
		...
		{ id: 'glorious-pridwen', name: "Glorious Pridwen", cost: 2550, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '20', 'Magical Protection': '20', 'Cooldown Rate': '12' }, image: getItemImage('glorious-pridwen'), passive: 'On Use: Explode (4.8m radius): Deal Magical Damage (40% of Protections), +25% Slow for 3s. Gain a Shield (125% of Protections) for 5s. When the Shield expires or breaks: Explode again: Deal Magic Damage (70% of your Protections). Cooldown: 45s. You can own up to 3 active items at once.' },
		...
		{ id: 'mystical-mail', name: "Mystical Mail", cost: 2550, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '25', 'Max Health': '300' }, image: getItemImage('mystical-mail'), passive: 'Enemies within 4m: 15 (+1 per Level) Magical Damage per 1s. Range Scaling Debuff: +50% at Close Range, -50% at Maximum Range.' },
		{ id: 'mantle-of-discord', name: "Mantle Of Discord", cost: 2600, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '30', 'Magical Protection': '20', 'Cooldown Rate': '10' }, image: getItemImage('mantle-of-discord'), passive: 'Damaged while below 40% Health: Stuns enemies within 3.2m for 1s, +Crowd Control Immunity for 1s. Cooldown: 110s.' },
		{ id: 'freyas-tears', name: "Freya's Tears", cost: 2600, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '20', 'Magical Protection': '25', 'Cooldown Rate': '20' }, image: getItemImage('freyas-tears'), passive: 'Lose 25% of your Health: +15 Physical and Magical Protections from items for 5s. Can stack up to 2 times.' },
		...
		{ id: 'dwarven-plate', name: "Dwarven Plate", cost: 2800, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '35', 'Magical Protection': '35' }, image: getItemImage('dwarven-plate'), passive: '+12.5% bonus Physical Protections from items. +25% bonus Magical Protections from items. On Use: Switch which Protection is increased more. Cooldown: 30s. You can own up to 3 active items at once.' },
		{ id: 'hussars-wings', name: "Hussar's Wings", cost: 3500, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '25', 'Magical Protection': '25', 'Max Health': '500' }, image: getItemImage('hussars-wings'), passive: 'You are Immune to Slows.' },
    ...
    { id: 'rod-of-asclepius', name: "Rod Of Asclepius", cost: 2350, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Intelligence': '55', 'Max Health': '225', 'Health Regen': '3' }, image: getItemImage('rod-of-asclepius'), passive: 'On Use: Heal all allies within 8.8m. +10% Health Heal over 10s. Counts as Ability healing. If target has 6 debuffs: +10% Health Heal instantly, Grants all non-damage immunities for 1s. Costs 35% Mana. Cooldown: 90s. You can own up to 3 active items at once.' },
		{ id: 'scepter-of-dominion', name: "Scepter of Dominion", cost: 2400, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Intelligence': '30', 'Max Health': '150', 'Max Mana': '200', 'Mana Regen': '3' }, image: getItemImage('scepter-of-dominion'), passive: 'On Use: Create a zone that puts gods into Stasis. The Zone appears after 1.5s. The Stasis lasts 2s. Cooldown: 90s. You can own up to 3 active items at once.' },
		{ id: 'lifebinder', name: "Lifebinder", cost: 2400, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Intelligence': '60', 'Max Health': '300', 'Health Regen': '3' }, image: getItemImage('lifebinder'), passive: 'On Use: Fire a Projectile that deals 60 (+8 per Level) Magical Damage. Marks enemy Gods for 6s. First ally to damage a Marked target: +60 (+8 per Level) Heal, +60 (+8 per Level) Shield. Consumes the Mark. Cooldown: 20s. You can own up to 3 active items at once.' },
		...
		{ id: 'golden-blade', name: "Golden Blade", cost: 2450, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Strength': '30', 'Max Health': '200', 'Attack Speed': '20%' }, image: getItemImage('golden-blade'), passive: 'Attacks deal bonus Physical Damage. Damage = +20 + +15% of your Item Protections. Damages all Enemies within 2.5m.' },
		...
		{ id: 'helm-of-radiance', name: "Helm of Radiance", cost: 2500, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Intelligence': '65', 'Physical Protection': '35' }, image: getItemImage('helm-of-radiance'), passive: 'Take Physical Damage: +7 Physical Protection for 6s. Stacks up to 4 times.' },
		{ id: 'gem-of-isolation', name: "Gem of Isolation", cost: 2500, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Intelligence': '50', 'Max Health': '250' }, image: getItemImage('gem-of-isolation'), passive: 'Damaging Ability Hit: 15% Slow. The Slow lasts for 2s.' },
		...
		{ id: 'runeforged-hammer', name: "Runeforged Hammer", cost: 2550, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Strength': '45', 'Max Health': '350', 'Health Regen': '3' }, image: getItemImage('runeforged-hammer'), passive: 'Hard Crowd Control a God: Mark them with a Rune for 5s. Attack to forge the Rune, dealing +50 (+65% of your Item Protections) as Magical Damage. Cooldown: 30s. Hard Crowd Control a God: -6s Item Cooldown.' },
		...
		{ id: 'void-shield', name: "Void Shield", cost: 2600, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Strength': '25', 'Physical Protection': '30', 'Max Health': '150' }, image: getItemImage('void-shield'), passive: 'Enemies within 8.8m: -10% Physical Protection. Range Scaling Debuff: +50% at Close Range, -50% at Maximum Range.' },
    { id: 'sanguine-lash', name: "Sanguine Lash", cost: 2650, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Magical Protection': '30', 'Strength': '35', 'Lifesteal': '5%' }, image: getItemImage('sanguine-lash'), passive: 'Enemies Within 4m: -0.75% Health (Max 200) as Physical Damage per 1s. +1% for every 10% Lifesteal. On Use: +5% Lifesteal for 4s, Now damages every 0.33s for 4s. Cooldown: 40s.' },
		{ id: 'shifters-shield', name: "Shifter's Shield", cost: 2650, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Physical Protection': '15', 'Magical Protection': '15', 'Max Health': '300' }, image: getItemImage('shifters-shield'), passive: 'Over 75% Health: +45 Strength or +55 Intelligence (whichever is higher). Under 75% Health: +20 Physical and Magical Protection.' },
		{ id: 'void-stone', name: "Void Stone", cost: 2650, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Intelligence': '40', 'Magical Protection': '35', 'Max Health': '150' }, image: getItemImage('void-stone'), passive: 'Enemies Within 8.8m: -10% Magical Protection. Range Scaling Debuff: +50% at Close Range, -50% at Maximum Range.' },
		{ id: 'tritons-conch', name: "Triton's Conch", cost: 2700, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Strength': '25', 'Intelligence': '40', 'Max Health': '250' }, image: getItemImage('tritons-conch'), passive: 'You and allies within 8.8m: +10 (+0.5 per Level) Strength, +10 (+1 per Level) Intelligence.' },
		...
		{ id: 'sphere-of-negation', name: "Sphere of Negation", cost: 2750, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Magical Protection': '70', 'Intelligence': '40' }, image: getItemImage('sphere-of-negation'), passive: 'Gain +2.5% Max Health Magical Shield every 3s, up to a maximum of +15% Max Health.' },
