...
export const ITEMS: Item[] = [
    ...
    // --- CONSUMABLES ---
    { id: 'eyes-jungle', name: 'Eyes of the Jungle', cost: 0, type: 'Consumable', category: 'Utility', stats: {}, image: 'https://image2url.com/images/1764385961853-89a46611-064e-4c62-a6be-e98305e45590.png', passive: 'Consume: Ping all enemy God locations on the minimap.' },
    { id: 'runic-bomb', name: 'Runic Bomb', cost: 0, type: 'Consumable', category: 'Offense', stats: {}, image: 'https://image2url.com/images/1764385987284-0077977c-c053-4f83-952f-7828623d22ca.png', passive: 'One Use: Throw a Bomb. After a delay: Deals 1000 True Damage to Minions and Structures. Deals 300 Physical Damage to enemies. Applies Knockback. Reduces enemy Attack Speed by 35% for 10s.' },
    { id: 'crystal-egg', name: 'Crystalline Egg', cost: 0, type: 'Consumable', category: 'Utility', stats: {}, image: 'https://image2url.com/images/1764386077353-8f330650-a922-46ee-8b12-1d5365850f8b.png', passive: 'Consume: Summon two Naga familiars. They attack your target.' },
    { id: 'obsidian-dagger', name: 'Obsidian Dagger', cost: 0, type: 'Consumable', category: 'Offense', stats: {}, image: 'https://image2url.com/images/1764386098577-a026bc86-a947-48e6-bbfd-76c9ff7ea3e4.png', passive: 'Consume: Take 500 True Damage. Gain +15% Damage and Attack Speed for 9s. If this Damage would kill you, instead become Immune and fully Heal over 3s.' },
    ...
    { id: 'elixir-strength', name: 'Elixir of Strength', cost: 3000, type: 'Consumable', category: 'Offense', stats: {}, image: 'https://image2url.com/images/1764386307773-55f1bfd8-2892-4041-91c3-09b619913df7.png', passive: 'Consume: +50 Strength. Buff that lasts for 360s (6 minutes). Can\'t be stacked.' },
    { id: 'elixir-intelligence', name: 'Elixir of Intelligence', cost: 3000, type: 'Consumable', category: 'Offense', stats: {}, image: 'https://image2url.com/images/1764386331746-33a2640f-a1dd-4af5-9d42-9a2c04c49db0.png', passive: 'Consume: +80 Intelligence. Buff that lasts for 360s (6 minutes). Can\'t be stacked.' },
    ...
    { id: 'war-banner', name: 'War Banner', cost: 1800, type: 'Starter', category: 'Utility', stats: { 'Phys. Prot': '30', 'Mag. Prot': '30', 'Max Health': '200', 'GP5': '1' }, image: 'https://image2url.com/images/1764386919912-4fba1bda-f992-4c40-b1a7-453ae48de391.png', passive: 'Assist Minion/Jungle: You and allies within 8.8m gain +1% Health Heal, +1.25% Mana Restore, +3.5% Move Speed, +6.5% Atk Speed. Move/Atk buff lasts 10s, stacks 6x.', buildsFrom: ['war-flag'] },
    ...
    { id: 'skeggox', name: 'Skeggox', cost: 1000, tier: 2, type: 'Item', category: 'Offense', stats: { 'Strength': '25' }, image: 'https://image2url.com/images/1764387897097-175e602b-1f51-456f-bec2-8a78e6bdd655.png', buildsFrom: ['axe'] },
    ...
    { id: 'infused-axe', name: 'Infused Axe', cost: 1050, tier: 2, type: 'Item', category: 'Offense', stats: { 'Strength': '15', 'Max Mana': '150', 'Mana Regen': '1' }, image: g'https://image2url.com/images/1764388216880-c07e1f47-ce8d-4701-9292-e4c1bce4b274.png', passive: 'Kill or Assist a God: +25% Mana', buildsFrom: ['axe', 'circlet'] },
    ...
    { id: 'blood-bound-book', name: 'Blood-Bound Book', cost: 2250, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '60', 'Lifesteal': '7.5%' }, image: getItemImage(/*ID*/), passive: 'On Use: +Health Shield for 6s. Shield = 7.5% Max Health & 75% Intelligence from items. While Shielded: +10% Lifesteal. Cooldown: 80s. Kill a God: -25% Cooldown.', buildsFrom: ['cursed-sickle', 'killing-stone' ] },
    { id: 'book-of-thoth', name: 'Book of Thoth', cost: 2300, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '30', 'Max Mana': '200', 'Mana Regen': '4' }, image: getItemImage(/*ID*/), passive: '+Intelligence equal to 5% of Mana from items. Deal 900 Damage to Minions or Jungle Monsters: +1 Stack. Damage dealt to Gods counts double. Per Stack: +10 Mana. At 50 Stacks, item evolves and gains: Additional +Intelligence equal to 2% of Mana from Items, +20 Intelligence, +100 Mana.' },
    { id: 'eros-bow', name: "Eros' Bow", cost: 2300, tier: 3, type: 'Item', category: 'Offense', stats: { 'Max Health': '300', 'Attack Speed': '30%' }, image: getItemImage(/*ID*/), passive: 'On Use: Mark an ally god. Only one ally may be Marked at a time. Mark breaks if ally is more than 20m away. On Attack Hit: Heal the Marked ally for +1.5% of your Max Health. Cooldown: 1s.' },
    { id: 'bancrofts-talon', name: "Bancroft's Talon", cost: 2300, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '55', 'Max Mana': '150', 'Mana Regen': '2', 'Lifesteal': '7.5%' }, image: getItemImage(/*ID*/), passive: 'Gain bonus Intelligence and Lifesteal scaled from missing Health. Caps at +60 Intelligence and +10% Lifesteal at 40% Health.' },
    { id: 'gem-of-focus', name: 'Gem of Focus', cost: 2350, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '50', 'Cooldown Rate': '20%' }, image: getItemImage(/*ID*/), passive: 'Ability Used: Gain a stack of Momentum. Momentum grants +4% Movement Speed for 6s. Stacks up to 3 times.' },
    { id: 'chronos-pendant', name: "Chronos' Pendant", cost: 2400, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '55', 'Cooldown Rate': '25%' }, image: getItemImage(/*ID*/), passive: 'Every 10s: -1s Ability Cooldowns.' },
    { id: 'jotunns-revenge', name: "Jotunn's Revenge", cost: 2400, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '40', 'Cooldown Rate': '25%' }, image: getItemImage(/*ID*/), passive: 'God Kill or Assist: -1s Cooldown for Non-Ultimate Abilities, -5s Cooldown for Ultimate Abilities.' },
    { id: 'dagger-of-frenzy', name: 'Dagger of Frenzy', cost: 2400, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '35', 'Attack Speed': '10%' }, image: getItemImage(/*ID*/), passive: 'On Use: +10 (+4 per Level) Attack Damage, +50% Attack Speed. Buff lasts 6 Attacks. Cooldown: 15s. Killing a God refreshes Cooldown.' },
    { id: 'sun-beam-bow', name: 'Sun Beam Bow', cost: 2400, tier: 3, type: 'Item', category: 'Offense', stats: { 'Attack Speed': '10%' }, image: getItemImage(/*ID*/), passive: 'Adaptive Stat: +40 Strength or +55 Intelligence (based on highest item stat). On Use: Fire +2 Projectiles per Attack. Deals 10 +30% Attack Damage as Magical Damage. 8.8m Range. Toggleable. -5% Max Mana per second while active. Structures and Bosses take 25% damage from Sun Beam Bow.' },
    { id: 'transcendence', name: 'Transcendence', cost: 2400, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '35', 'Max Mana': '400', 'Mana Regen': '4' }, image: getItemImage(/*ID*/), passive: '+Strength equal to 3% of Mana from Items. Deal 700 Damage to Minions or Jungle Monsters: +1 Stack. Damage dealt to Gods counts double. Per Stack: +7 Mana. At 50 Stacks, item evolves and gains: +15 Strength, +100 Mana.' },
    { id: 'odysseus-bow', name: "Odysseus' Bow", cost: 2450, tier: 3, type: 'Item', category: 'Offense', stats: { 'Attack Speed': '45%' }, image: getItemImage(/*ID*/), passive: 'Every fourth Attack Hit: Trigger Chain Lightning. Damage = 15 (+60% Attack Damage) Physical Damage. Hits target and up to 4 nearby enemies. Bounce Range: 4.8m. Can hit the same target more than once.' },
    { id: 'hydras-lament', name: "Hydra's Lament", cost: 2450, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '45', 'Max Mana': '200', 'Mana Regen': '4', 'Cooldown Rate': '10%' }, image: getItemImage(/*ID*/), passive: 'Ability Used: +30% Damage on your next Attack. Buff lasts 8s.' },
    { id: 'hydras-lament', name: "Hydra's Lament", cost: 2450, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '45', 'Max Mana': '200', 'Mana Regen': '4', 'Cooldown Rate': '10%' }, image: getItemImage(/*ID*/), passive: 'Ability Used: +30% Damage on your next Attack. Buff lasts 8s.' },
    { id: 'rage', name: 'Rage', cost: 2450, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '30', 'Critical Chance': '20%' }, image: getItemImage(/*ID*/), passive: 'God Kill or Assist: +4% Critical Strike Chance (Max 20%). After 5 God Kills or Assists: +10% additional Critical Strike Chance.' },
    { id: 'barbed-carver', name: 'Barbed Carver', cost: 2500, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '40', 'Lifesteal': '7.5%' }, image: getItemImage(/*ID*/), passive: 'Ability Hit: Target gains +1 Stack of Jagged Wounds for 5s (max 3). Triggers once per Ability, per target. Each Stack: +8% (+1% per 10% Lifesteal) Attack and Ability Damage as Physical Damage.' },
    { id: 'daybreak-gavel', name: 'Daybreak Gavel', cost: 2500, tier: 3, type: 'Item', category: 'Offense', stats: { 'Max Health': '300' }, image: getItemImage(/*ID*/), passive: 'Adaptive Stat: +60 Strength or +80 Intelligence (based on highest item stat). Each unique god Healed by a Healing Ability: +1 Stack (max 4). Non Healing Ability Use: Consume all Stacks, +13 Strength or +16 Intelligence (based on highest item stat) for 8s per Stack (max 4).' },
    { id: 'bracer-of-the-abyss', name: 'Bracer of The Abyss', cost: 2500, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '45', 'Attack Speed': '30%' }, image: getItemImage(/*ID*/), passive: 'Hit enemy Gods or Jungle Bosses: +10 Attack Damage for 10s. Stacks up to 8 times.' },
    { id: 'vital-amplifier', name: 'Vital Amplifier', cost: 2500, tier: 3, type: 'Item', category: 'Offense', stats: { 'Max Health': '200', 'Health Regen': '3', 'Attack Speed': '10%' }, image: getItemImage(/*ID*/), passive: 'Adaptive Stat: +30 Strength or +45 Intelligence (based on highest item stat). Heal yourself or an ally with an Ability: +7.5% Attack Speed, +5% Attack Damage. Buff lasts 6s, Stacks up to 3x.' },
    { id: 'nimble-ring', name: 'Nimble Ring', cost: 2500, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '35', 'Attack Speed': '20%', 'Lifesteal': '7.5%' }, image: getItemImage(/*ID*/), passive: 'For every 10 Intelligence: +1 Attack Damage, +1% Attack Speed.' },
    { id: 'lernaean-bow', name: 'Lernaean Bow', cost: 2500, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '40', 'Attack Speed': '30%' }, image: getItemImage(/*ID*/), passive: 'On Use: Fire 3 arrows that pierce enemies in a 10.5m line. Deals 40% of your Attack Damage as Physical Damage. -50% Shield. Can Critically Strike. Cooldown: 30s.' },
    { id: 'divine-ruin', name: 'Divine Ruin', cost: 2500, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '95' }, image: getItemImage(/*ID*/), passive: 'Ability or Attack Hit Enemy God: Trigger Chain Lightning. Magical Damage = 40 + 20% Intelligence. Hits enemy and up to 4 nearby enemies, Marking them for 6s. Bounce Range: 4.8m. Can hit the same target more than once. Cooldown: 15s. Mark: On target Heals 50 Health: -0.25 Cooldown.' },
    { id: 'devourers-gauntlet', name: "Devourer's Gauntlet", cost: 2500, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '35', 'Lifesteal': '5%' }, image: getItemImage(/*ID*/), passive: 'Kill Minion or Jungle Monsters: +1 Stack. Each Stack grants: +.4 Strength, +0.05% Lifesteal. At 75 Stacks, gain: +10 Strength, +3% Lifesteal. Continue to stack more Slowly; 10 Minion Kills: +1 Stack, Jungle Boss Kill or Assist: +5 Stacks.' },
    { id: 'soul-gem', name: 'Soul Gem', cost: 2500, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '60', 'Lifesteal': '7.5%', 'Cooldown Rate': '10%' }, image: getItemImage(/*ID*/), passive: 'Ability Hit: +1 Stack. Three Stacks: Next Ability Hit: Deals Bonus Damage (40% Intelligence), +20(+6 per Level) Heal you and allies within 3.2m. Removes the Stacks.' },
    { id: 'the-executioner', name: 'The Executioner', cost: 2550, tier: 3, type: 'Item', category: 'Offense', stats: { 'Attack Speed': '15%' }, image: getItemImage(/*ID*/), passive: 'Adaptive Stat: +30 Strength or +55 Intelligence (based on highest item stat). Attack a God or Boss: Apply 1 Stack of Piercing. Piercing reduces 6% Protections for 4s. Stacks up to 5 times.' },
    { id: 'polynomicon', name: 'Polynomicon', cost: 2550, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '75', 'Max Mana': '200', 'Mana Regen': '3' }, image: getItemImage(/*ID*/), passive: 'Ability Used: Your next Attack deals bonus Magical Damage. Damage = 60% of your Intelligence.' },
    { id: 'bloodforge', name: 'Bloodforge', cost: 2550, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '45', 'Lifesteal': '7.5%' }, image: getItemImage(/*ID*/), passive: 'On Use: +Health Shield for 6s. Shield = 10% Max Health & 150% Strength from Items. While Shielded: +10% Lifesteal. Cooldown: 80s. Kill a God: -25% Cooldown.' },
    { id: 'oath-sworn-spear', name: 'Oath-Sworn Spear', cost: 2550, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '60' }, image: getItemImage(/*ID*/), passive: 'Ability Hit: Target is -1 Physical Protection per your Level for 4s.' },
    { id: 'bragis-harp', name: "Bragi's Harp", cost: 2550, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '35', 'Intelligence': '25', 'Attack Speed': '10%' }, image: getItemImage(/*ID*/), passive: 'Attack Hit: +10 (+3 per Level) bonus Magical Damage. Structures and Bosses take half damage from Bragi\'s Harp.' },
    { id: 'necronomicon', name: 'Necronomicon', cost: 2550, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '50', 'Max Mana': '300', 'Mana Regen': '5' }, image: getItemImage(/*ID*/), passive: 'God Kill or Assist: +1 Stack of: +30 Intelligence. Stacks up to 6 times. On Death: Lose 4 Stacks.' },
    { id: 'typhons-heart', name: "Typhon's Heart", cost: 2600, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '50', 'Lifesteal': '12.5%' }, image: getItemImage(/*ID*/), passive: 'On Minion or Jungle Kill: +1 Stack. On God Kill: +30 Stacks. On Assist: +15 Stacks. At 30 Stacks: Summon a Monster of Typhon. Health = 200 (+55 per Level). Damage = 300% of your Lifesteal and 30% of your Intelligence. Your Lifesteal heals the monster. If another would be summoned: Fully Heal current monster, Buff it with +25% Health, Attack Speed, and Movement Speed (Stacks up to 5x).' },
    { id: 'the-reaper', name: 'The Reaper', cost: 2600, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '65', 'Lifesteal': '10%' }, image: getItemImage(/*ID*/), passive: 'Kill a God: Heal +15% of Slain God\'s Max Health. Assist a God: Heal +7.5% of Slain God\'s Max Health. During Moonlight Phase: Heal +15% of Slain God\'s Max Health, on Kill or Assist.' },
    { id: 'qins-blade', name: "Qin's Blade", cost: 2600, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '20', 'Attack Speed': '25%' }, image: getItemImage(/*ID*/), passive: 'Enemies within 12.8m gain 1 Stack of Qin\'s Mark for every 100 Health they heal. Lasts 6s (Max 6). Attack Hit: +Bonus Physical Damage. Bonus Damage = 1.5% Target Maximum Health + Choose Highest: 7.5% of the difference in Maximum Health, 0.5% Target Maximum Health (Per stack of Qin\'s Mark).' },
    { id: 'ancient-signet', name: 'Ancient Signet', cost: 2600, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '80', 'Max Mana': '250' }, image: getItemImage(/*ID*/), passive: 'Ability Hit: +20 (+12 per Level) bonus Magical Damage. Cooldown: 15s. -2s Cooldown for each minion kill or assist.' },
    { id: 'gluttonous-grimoire', name: 'Gluttonous Grimoire', cost: 2600, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '40', 'Max Health': '150', 'Lifesteal': '7.5%' }, image: getItemImage(/*ID*/), passive: 'Store 25% of your Lifesteal healing as bonus Magical Damage on your next Attack. If at full Health: Store 40% instead. Stored damage is capped to 33% of your Max Health.' },
    { id: 'death-metal', name: 'Death Metal', cost: 2600, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '35', 'Intelligence': '40', 'Critical Chance': '15%' }, image: getItemImage(/*ID*/), passive: 'On Use: You and Allies within 6.4m gain: +25% Crit Chance, +25% Attack Speed. Buff lasts 6s. Cooldown: 45s.' },
    { id: 'tyrfing', name: 'Tyrfing', cost: 2600, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '45', 'Attack Speed': '10%' }, image: getItemImage(/*ID*/), passive: 'Attacks deal +15 bonus Physical Damage. On God hit: Increase bonus Damage by +15 for 4s. Stacks once, +1 Stack per 4 Levels (Max 6 Stacks).' },
    { id: 'the-cosmic-horror', name: 'The Cosmic Horror', cost: 2650, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '85', 'Max Mana': '200', 'Mana Regen': '3', 'Cooldown Rate': '10%' }, image: getItemImage(/*ID*/), passive: 'Have 275+ Item Intelligence: +10 Cooldown Rate.' },
    { id: 'hastened-fatalis', name: 'Hastened Fatalis', cost: 2650, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '20', 'Attack Speed': '25%' }, image: getItemImage(/*ID*/), passive: 'Attack Hits a God: -12.5% Attack Movement Penalty. Melee hits grants 2 Stacks. Stacks up to 4 times. Buff lasts 2s.' },
    { id: 'avenging-blade', name: 'Avenging Blade', cost: 2650, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '60', 'Max Health': '200' }, image: getItemImage(/*ID*/), passive: 'Attack hit a God: Debuff that God. -3.5% Protections. When Debuffed God is in Jungle OR Heals 5% of their Health: Stacks become twice as effective. Debuff lasts 4s, Stacks up to 3 times.' },
    { id: 'spear-of-desolation', name: 'Spear of Desolation', cost: 2650, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '100', 'Cooldown Rate': '10%' }, image: getItemImage(/*ID*/), passive: 'God Kill or Assist: -3s Non Ultimate Cooldowns, -10s Ultimate Cooldowns.' },
    { id: 'arondight', name: 'Arondight', cost: 2650, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '55', 'Cooldown Rate': '15%' }, image: getItemImage(/*ID*/), passive: 'On Use: Reveal enemy Gods within 17.6m for 6s. Reveal persists through Stealth. If any God is revealed, +25% Movement Speed for 6s. First time you damage a revealed God: +30 (+50% Strength) Physical Damage. Cooldown: 60s.' },
    { id: 'riptalon', name: 'Riptalon', cost: 2700, tier: 3, type: 'Item', category: 'Offense', stats: { 'Attack Speed': '20%', 'Lifesteal': '7.5%', 'Basic Attack Power': '25%' }, image: getItemImage(/*ID*/), passive: 'While Above 50% Health: +10% Attack Damage. While Below 50% Health: +25% Attack Damage, +7.5% Lifesteal.' },
    { id: 'musashis-dual-swords', name: "Musashi's Dual Swords", cost: 2700, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '35', 'Critical Chance': '30%' }, image: getItemImage(/*ID*/), passive: 'Critically Strike: +15% Movement Speed for 5s.' },
    { id: 'tekko-kagi', name: 'Tekko-Kagi', cost: 2700, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '60', 'Cooldown Rate': '10%' }, image: getItemImage(/*ID*/), passive: 'Ability Used: Gain a stack of Momentum. Momentum grants +4% Movement Speed for 6s. Stacks up to 3 times.' },
    { id: 'doom-orb', name: 'Doom Orb', cost: 2700, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '90', 'Max Mana': '200', 'Mana Regen': '2' }, image: getItemImage(/*ID*/), passive: 'Kill or Assist a Minion: +1 Stack. Kill or Assist a God: +5 Stacks. Per Stack: +8 Intelligence. Max 5 Stacks. Stacks last 10s. Stacks fall off one at a time.' },
    { id: 'jade-scepter', name: 'Jade Scepter', cost: 2750, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Intelligence': '90', 'Max Health': '150' }, image: getItemImage(/*ID*/), passive: 'On Use: Displace enemy Gods in front of you, pushing them away. Cooldown: 60s.' },
    { id: 'demon-blade', name: 'Demon Blade', cost: 2750, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '30', 'Attack Speed': '15%', 'Critical Chance': '15%' }, image: getItemImage(/*ID*/), passive: 'Critically Strike: +30% Attack Speed for 3s.' },
    { id: 'staff-of-myrddin', name: 'Staff of Myrddin', cost: 2750, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '70', 'Cooldown Rate': '10%' }, image: getItemImage(/*ID*/), passive: 'On Use: Next non-Ultimate Ability used will have no cooldown. Cooldown: 80s.' },
    { id: 'the-crusher', name: 'The Crusher', cost: 2800, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '60', 'Cooldown Rate': '15%' }, image: getItemImage(/*ID*/), passive: 'Ability Hit: +Physical Damage. Damage = 35% of your Strength. Damage is dealt over 1s. Subsequent hits on the same target deal 50% bonus Damage, over 3s.' },
    { id: 'totem-of-death', name: 'Totem of Death', cost: 2800, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '60', 'Cooldown Rate': '15%' }, image: getItemImage(/*ID*/), passive: 'Ability Hit a God or Boss: Apply 1 Stack of Piercing. Piercing reduces 6% Protections for 4s. Stacks up to 5 times.' },
    { id: 'the-world-stone', name: 'The World Stone', cost: 2800, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '70', 'Max Mana': '250', 'Mana Regen': '3' }, image: getItemImage(/*ID*/), passive: '-30% Cooldown for your Ultimate Ability.' },
    { id: 'pendulum-blade', name: 'Pendulum Blade', cost: 2800, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '45', 'Cooldown Rate': '10%' }, image: getItemImage(/*ID*/), passive: 'On Use: -4s Ability Cooldowns. Cooldown: 40s.' },
    { id: 'deathbringer', name: 'Deathbringer', cost: 2900, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '45', 'Critical Chance': '20%' }, image: getItemImage(/*ID*/), passive: '+35% Critical Strike Damage.' },
    { id: 'soul-reaver', name: 'Soul Reaver', cost: 2950, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '60', 'Max Mana': '250', 'Mana Regen': '5' }, image: getItemImage(/*ID*/), passive: 'Abilities deal bonus Magical Damage to Gods with more Maximum Health than you. Damage = 8% of Maximum Health difference + 5% of your Intelligence, dealt 4 times over 2s. Triggers once per Ability Cast, per God.' },
    { id: 'heartseeker', name: 'Heartseeker', cost: 3000, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '55', 'Max Mana': '250', 'Mana Regen': '2' }, image: getItemImage(/*ID*/), passive: 'Ability Hit: +%Health Physical Damage. Damage = 2.5% of your Strength, as a % of the target\'s Max Health.' },
    { id: 'rod-of-tahuti', name: 'Rod of Tahuti', cost: 3000, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '85', 'Max Mana': '250', 'Mana Regen': '2' }, image: getItemImage(/*ID*/), passive: '+Intelligence equal to 25% of your Intelligence from items.' },
    { id: 'obsidian-shard', name: 'Obsidian Shard', cost: 3050, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '60' }, image: getItemImage(/*ID*/), passive: 'Gain the Shattering effect: +35% Penetration. Does not stack with itself.' },
    { id: 'titans-bane', name: "Titan's Bane", cost: 3100, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '50' }, image: getItemImage(/*ID*/), passive: 'Gain the Shattering effect: +35% Penetration. Does not stack with itself.' },
    { id: 'dreamers-idol', name: "Dreamer's Idol", cost: 3500, tier: 3, type: 'Item', category: 'Offense', stats: { 'Intelligence': '140' }, image: getItemImage(/*ID*/), passive: 'On Use: +25% Intelligence, Become Immune to Displacement. Buff lasts 10s. Cooldown: 120s.' },
    { id: 'avatars-parashu', name: "Avatar's Parashu", cost: 3700, tier: 3, type: 'Item', category: 'Offense', stats: { 'Strength': '100' }, image: getItemImage(/*ID*/), passive: 'On Use: +25% Strength and Immune to Displacement for 10s. Cooldown: 120s.' },
    { id: 'gauntlet-of-thebes', name: "Gauntlet of Thebes", cost: 2200, tier: 3, type: 'Item', category: 'Defense', stats: { 'Max Health': '200', 'Max Mana': '150' }, image: getItemImage(/*ID*/), passive: 'Assist a Minion: +1 Stack. God Kill or Assist: +5 Stacks. Stacks grant +15 Max Health (max 40 Stacks). At 40 Stacks, Item evolves: +200 Max Health.' },
		{ id: 'yogis-necklace', name: "Yogi's Necklace", cost: 2250, tier: 3, type: 'Item', category: 'Defense', stats: { 'Max Health': '400', 'Max Mana': '250', 'Health Regen': '6', 'Mana Regen': '6' }, image: getItemImage(/*ID*/), passive: 'Heal +0.5% of your Max Health per second.' },
		{ id: 'chandras-grace', name: "Chandra's Grace", cost: 2300, tier: 3, type: 'Item', category: 'Defense', stats: { 'Max Health': '350', 'Cooldown Rate': '20' }, image: getItemImage(/*ID*/), passive: 'Every 30s: Lowest Health Ally within 8.8m gain: +20 Health Regen, +20 Mana Regen, 0.2s off Cooldowns every 0.2s for 4s. Buff lasts 3s. During Moonlight Phase: On trigger, you also gain the Buff.' },
		{ id: 'eye-of-providence', name: "Eye of Providence", cost: 2300, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '25', 'Magical Protection': '25', 'Max Health': '250' }, image: getItemImage(/*ID*/), passive: 'Destroy a Ward: +50 Gold. On Use: Place a Ward. Reveals enemies and enemy wards within 7.2m. Lasts 120s or until destroyed. Cooldown: 60s. (Max 2 Wards can be Placed) You can own up to 3 active items at once.' },
		{ id: 'spectral-armor', name: "Spectral Armor", cost: 2300, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '30', 'Max Health': '400' }, image: getItemImage(/*ID*/), passive: 'Enemies within 8.8m: -25% Attack Speed, Deal -25% Damage with Critical Strikes.' },
		{ id: 'amanita-charm', name: "Amanita Charm", cost: 2350, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '15', 'Magical Protection': '15', 'Max Health': '300', 'Health Regen': '4' }, image: getItemImage(/*ID*/), passive: 'On Use: Create a Healing Mushroom (6.4m radius) for 4.5s. +3% Health Heal every 1.5s, +1 Stack of Damage Reduction per Heal, 10% Basic and Ability Damage Reduction per Stack, 5% Ultimate Damage Reduction per Stack. All Stacks removed after triggering. Cooldown: 60s. You can own up to 3 active items at once.' },
		{ id: 'genjis-guard', name: "Genji's Guard", cost: 2350, tier: 3, type: 'Item', category: 'Defense', stats: { 'Magical Protection': '50', 'Max Mana': '200', 'Mana Regen': '5', 'Cooldown Rate': '15' }, image: getItemImage(/*ID*/), passive: 'Hit by Magical Ability Damage: -3s Cooldowns. Cooldown: 15s.' },
		{ id: 'erosion', name: "Erosion", cost: 2400, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '30', 'Magical Protection': '20', 'Max Health': '250' }, image: getItemImage(/*ID*/), passive: '-30% Shields applied to enemy Gods within 11.2m. When this occurs: +10% of your Physical and Magical Protections for 6s. Can stack up to 2 times.' },
		{ id: 'shield-of-the-phoenix', name: "Shield of the Phoenix", cost: 2400, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '15', 'Max Health': '225', 'Cooldown Rate': '10' }, image: getItemImage(/*ID*/), passive: 'Ability Hit a God: +1.5% Health Heal, +2% Mana Restore. Triggers once per Ability, per God hit.' },
		{ id: 'contagion', name: "Contagion", cost: 2400, tier: 3, type: 'Item', category: 'Defense', stats: { 'Max Health': '425', 'Health Regen': '6' }, image: getItemImage(/*ID*/), passive: 'Damaged by an Attack or Ability: Apply +1 Stack of Contagion (1 per hit). If an enemy Lifesteals 100 Health from you: Apply +5 Stacks. Attack or Hard Crowd Control an afflicted enemy: Deal Magical Damage = 1% Max Health per stack in a 4m radius, Remove the Stacks.' },
		{ id: 'breastplate-of-valor', name: "Breastplate of Valor", cost: 2400, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '35', 'Max Mana': '200', 'Mana Regen': '2', 'Cooldown Rate': '20' }, image: getItemImage(/*ID*/), passive: 'Lose 500 (+25 per Level) Health: -1s Ability Cooldowns. 25% of Self-Healing from Abilities counts towards the lost health trigger.' },
		{ id: 'magis-cloak', name: "Magi's Cloak", cost: 2400, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '35', 'Magical Protection': '35' }, image: getItemImage(/*ID*/), passive: 'Every 90s: Gain a Hard Crowd Control protective bubble. When triggered, gain Crowd Control Immunity for 1.5s.' },
    ...
    { id: 'gauntlet-of-thebes', name: "Gauntlet of Thebes", cost: 2200, tier: 3, type: 'Item', category: 'Defense', stats: { 'Max Health': '200', 'Max Mana': '150' }, image: getItemImage(/*ID*/), passive: 'Assist a Minion: +1 Stack. God Kill or Assist: +5 Stacks. Stacks grant +15 Max Health (max 40 Stacks). At 40 Stacks, Item evolves: +200 Max Health.' },
		...
		{ id: 'breastplate-of-valor', name: "Breastplate of Valor", cost: 2400, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '35', 'Max Mana': '200', 'Mana Regen': '2', 'Cooldown Rate': '20' }, image: getItemImage(/*ID*/), passive: 'Lose 500 (+25 per Level) Health: -1s Ability Cooldowns. 25% of Self-Healing from Abilities counts towards the lost health trigger.' },
		{ id: 'magis-cloak', name: "Magi's Cloak", cost: 2400, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '35', 'Magical Protection': '35' }, image: getItemImage(/*ID*/), passive: 'Every 90s: Gain a Hard Crowd Control protective bubble. When triggered, gain Crowd Control Immunity for 1.5s.' },
    { id: 'screeching-gargoyle', name: "Screeching Gargoyle", cost: 2400, tier: 3, type: 'Item', category: 'Defense', stats: { 'Magical Protection': '50', 'Cooldown Rate': '15' }, image: getItemImage(/*ID*/), passive: 'On Use: Enemies in front of you: Silenced for 1s, -10% Protections for 4s. Cooldown: 90s. During Moonlight Phase: Hits enemies around you, Silence lasts 1.5s, -15% Protections. You can own up to 3 active items at once.' },
		{ id: 'phoenix-feather', name: "Phoenix Feather", cost: 2400, tier: 3, type: 'Item', category: 'Defense', stats: { 'Magical Protection': '35', 'Max Health': '300' }, image: getItemImage(/*ID*/), passive: 'On Use: Fire 3 Pulses that Heal you and True Damage enemies within 3.2m. Heal = +75 Health +7.5 Missing Health. True Damage = +3% Max Health from Items. Cooldown: 120s. You can own up to 3 active items at once.' },
		{ id: 'prophetic-cloak', name: "Prophetic Cloak", cost: 2400, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '22', 'Magical Protection': '22', 'Cooldown Rate': '10' }, image: getItemImage(/*ID*/), passive: 'Damage a God: +1 Protection Stack against the damage type they deal. Cooldown: 5s. At +20 of each Protection Stack, item evolves: +5 Physical Protection and Magical Protection, +6% Damage Mitigation (or +12% if total Protections > 300).' },
		{ id: 'stampede', name: "Stampede", cost: 2400, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '30', 'Max Health': '250', 'Health Regen': '5' }, image: getItemImage(/*ID*/), passive: 'On Use: You and allies within 6.4m gain: Slow Immunity, +60% Movement Speed that decays to +20% over 4s. Cooldown: 90s. You can own up to 3 active items at once.' },
		{ id: 'berserkers-shield', name: "Berserker's Shield", cost: 2400, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '30', 'Magical Protection': '15', 'Attack Speed': '20%' }, image: getItemImage(/*ID*/), passive: 'When falling below 60% Health: Become Berserk for 8s. While Berserk: +65% Protections from Items, +25% Attack Speed.' },
		{ id: 'pharaohs-curse', name: "Pharaoh's Curse", cost: 2450, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '35', 'Magical Protection': '25', 'Attack Speed': '15%' }, image: getItemImage(/*ID*/), passive: 'On Use: Enemies within 5.6m: -50% Shields, -20% Movement Speed, -40% Attack Speed. Debuff lasts 4s. Cooldown: 45s. You can own up to 3 active items at once.' },
		{ id: 'gladiators-shield', name: "Gladiator's Shield", cost: 2450, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '25', 'Max Health': '200', 'Cooldown Rate': '10' }, image: getItemImage(/*ID*/), passive: 'Abilities deal bonus Physical Damage. Damage = +10 + 40 of your Item Protections. Triggers once per Ability Cast, per God.' },
		{ id: 'umbral-link', name: "Umbral Link", cost: 2500, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '40', 'Lifesteal': '10%' }, image: getItemImage(/*ID*/), passive: 'Above 50% Health: Split your Lifesteal Healing with allies within 11.2m. +10 Physical and Magical Protections for 8s per unique ally Healed.' },
		{ id: 'shoguns-ofuda', name: "Shogun's Ofuda", cost: 2500, tier: 3, type: 'Item', category: 'Defense', stats: { 'Magical Protection': '30', 'Max Health': '200', 'Attack Speed': '15%' }, image: getItemImage(/*ID*/), passive: '+20% Attack Speed for you and allies within 8.8m.' },
		{ id: 'ancile', name: "Ancile", cost: 2500, tier: 3, type: 'Item', category: 'Defense', stats: { 'Magical Protection': '45', 'Max Health': '250' }, image: getItemImage(/*ID*/), passive: '-10% Attack Damage taken. On Use: Your next Ability that damages a god Silences them for 1.5s. Cooldown: 70s. Take Attack Damage: -2s Item Cooldown. You can own up to 3 active items at once.' },
		{ id: 'spirit-robe', name: "Spirit Robe", cost: 2500, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '25', 'Magical Protection': '25' }, image: getItemImage(/*ID*/), passive: 'Hit by Hard Crowd Control: +40 Physical Protection, +40 Magical Protection, +4% Health Heal over time. Buff lasts 6s.' },
		{ id: 'oni-hunters-garb', name: "Oni Hunter's Garb", cost: 2500, tier: 3, type: 'Item', category: 'Defense', stats: { 'Magical Protection': '40', 'Max Health': '150', 'Max Mana': '200', 'Mana Regen': '8' }, image: getItemImage(/*ID*/), passive: 'For each enemy god within 8.8m: +4% Damage Mitigation. Max 3 stacks.' },
    { id: 'leviathans-hide', name: "Leviathan's Hide", cost: 2500, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '40', 'Max Health': '250' }, image: getItemImage(/*ID*/), passive: 'Damaged by God Attack: That God is -10% Strength & Attack Damage for 4s. Attack an Enemy God: +8 Max Health Permanently. Cooldown: 10s. Damaged by Enemy God: -0.5s once per Ability Cast or Attack.' },
		{ id: 'talisman-of-purification', name: "Talisman of Purification", cost: 2500, tier: 3, type: 'Item', category: 'Defense', stats: { 'Magical Protection': '30', 'Max Health': '300', 'Cooldown Rate': '10' }, image: getItemImage(/*ID*/), passive: 'On Use: You and Allies within 6.4m: Are Cleansed of all Crowd Control, Gain Crowd Control Immunity for 1s. Cooldown: 140s. You can own up to 3 active items at once.' },
		{ id: 'stone-of-binding', name: "Stone of Binding", cost: 2550, tier: 3, type: 'Item', category: 'Defense', stats: { 'Magical Protection': '25', 'Physical Protection': '35' }, image: getItemImage(/*ID*/), passive: 'Hard Crowd Control an Enemy: Apply -7 Physical and Magical Protections for 6s. Stacks up to 3 times. Stacks fall off one at a time.' },
		{ id: 'regrowth-striders', name: "Regrowth Striders", cost: 2550, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '35', 'Mana Regen': '3', 'Cooldown Rate': '15' }, image: getItemImage(/*ID*/), passive: 'Heal yourself with an Ability: +25% Movement Speed (decays to 0%) for 4s. Cooldown: 10s. Gain any Movement Speed buff: +5% Health Heal over 10s.' },
		{ id: 'glorious-pridwen', name: "Glorious Pridwen", cost: 2550, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '20', 'Magical Protection': '20', 'Cooldown Rate': '12' }, image: getItemImage(/*ID*/), passive: 'On Use: Explode (4.8m radius): Deal Magical Damage (40% of Protections), +25% Slow for 3s. Gain a Shield (125% of Protections) for 5s. When the Shield expires or breaks: Explode again: Deal Magic Damage (70% of your Protections). Cooldown: 45s. You can own up to 3 active items at once.' },
		{ id: 'stygian-anchor', name: "Stygian Anchor", cost: 2550, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '35', 'Magical Protection': '30' }, image: getItemImage(/*ID*/), passive: 'On God Damage Dealt: Apply 1 Stack of Stygian Sludge for 1.25s. (Max 5) Stacks fall off one at a time. Per Stack: -3% Movement Speed, -3% Attack Speed, 4% of their Healing Echoed to you.' },
		{ id: 'hide-of-the-nemean-lion', name: "Hide of the Nemean Lion", cost: 2550, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '35', 'Max Health': '350', 'Health Regen': '4' }, image: getItemImage(/*ID*/), passive: 'On Use: Reflect: 40% of pre-mitigated Attack Damage, 20% of pre-mitigated Ability Damage. Damage is Reflected as Physical Damage. Buff lasts 4s. Cooldown: 60s. You can own up to 3 active items at once.' },
		{ id: 'mystical-mail', name: "Mystical Mail", cost: 2550, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '25', 'Max Health': '300' }, image: getItemImage(/*ID*/), passive: 'Enemies within 4m: 15 (+1 per Level) Magical Damage per 1s. Range Scaling Damage: +50% at Close Range, -50% at Maximum Range.' },
		{ id: 'mantle-of-discord', name: "Mantle Of Discord", cost: 2600, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '30', 'Magical Protection': '20', 'Cooldown Rate': '10' }, image: getItemImage(/*ID*/), passive: 'Damaged while below 40% Health: Stuns enemies within 3.2m for 1s, +Crowd Control Immunity for 1s. Cooldown: 110s.' },
		{ id: 'freyas-tears', name: "Freya's Tears", cost: 2600, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '20', 'Magical Protection': '25', 'Cooldown Rate': '20' }, image: getItemImage(/*ID*/), passive: 'Lose 25% of your Health: +15 Physical and Magical Protections from items for 5s. Can stack up to 2 times.' },
		{ id: 'heartwood-charm', name: "Heartwood Charm", cost: 2650, tier: 3, type: 'Item', category: 'Defense', stats: { 'Max Health': '400', 'Max Mana': '250', 'Cooldown Rate': '10' }, image: getItemImage(/*ID*/), passive: '-20% Cooldowns for your Healing Abilities. On Use: Your next non-Ultimate Healing Ability has no cooldown. -50% Damage on this Ability. Cooldown: 120s. -6s Cooldown on each Healing Ability Cast. You can own up to 3 active items at once.' },
		{ id: 'draconic-scale', name: "Draconic Scale", cost: 2700, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '20', 'Magical Protection': '20', 'Max Health': '300' }, image: getItemImage(/*ID*/), passive: 'Damaged by a God: Gain 2 Protections (+3% bonus Protections from items) against that God\'s damage type. Stacks last 1.5s (max 7). Stacks decay 1 at a time.' },
		{ id: 'xibalban-effigy', name: "Xibalban Effigy", cost: 2750, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '30', 'Magical Protection': '30', 'Max Mana': '300', 'Mana Regen': '4' }, image: getItemImage(/*ID*/), passive: 'On Use: Take 50% Damage for 4s. After: Take Physical Damage equal to mitigated Damage. Cannot drop below 5% Health. During Moonlight Phase: Only 50% of the mitigated Damage is dealt back. You can own up to 3 active items at once.' },
		{ id: 'circes-hexstone', name: "Circe's Hexstone", cost: 2750, tier: 3, type: 'Item', category: 'Defense', stats: { 'Max Health': '250', 'Health Regen': '4', 'Cooldown Rate': '10' }, image: getItemImage(/*ID*/), passive: 'On Use: Become Polymorphed, Dash Forward dealing 50 Physical Damage, +CC Immune, +60 Physical and Magical Protection. On Enemy God Hit: Knock Up, Bonus Damage equal to 10% of Current Health, -40s Cooldown. Cooldown: 120s. You can own up to 3 active items at once.' },
		{ id: 'dwarven-plate', name: "Dwarven Plate", cost: 2800, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '35', 'Magical Protection': '35' }, image: getItemImage(/*ID*/), passive: '+12.5% bonus Physical Protections from items. +25% bonus Magical Protections from items. On Use: Switch which Protection is increased more. Cooldown: 30s. You can own up to 3 active items at once.' },
		{ id: 'hussars-wings', name: "Hussar's Wings", cost: 3500, tier: 3, type: 'Item', category: 'Defense', stats: { 'Physical Protection': '25', 'Magical Protection': '25', 'Max Health': '500' }, image: getItemImage(/*ID*/), passive: 'You are Immune to Slows.' },

    // --- TIER 3 Hybrid
    { id: 'rod-of-asclepius', name: "Rod Of Asclepius", cost: 2350, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Intelligence': '55', 'Max Health': '225', 'Health Regen': '3' }, image: getItemImage(/*ID*/), passive: 'On Use: Heal all allies within 8.8m. +10% Health Heal over 10s. Counts as Ability healing. If target has 6 debuffs: +10% Health Heal instantly, Grants all non-damage immunities for 1s. Costs 35% Mana. Cooldown: 90s. You can own up to 3 active items at once.' },
		{ id: 'scepter-of-dominion', name: "Scepter of Dominion", cost: 2400, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Intelligence': '30', 'Max Health': '150', 'Max Mana': '200', 'Mana Regen': '3' }, image: getItemImage(/*ID*/), passive: 'On Use: Create a zone that puts gods into Stasis. The Zone appears after 1.5s. The Stasis lasts 2s. Cooldown: 90s. You can own up to 3 active items at once.' },
		{ id: 'lifebinder', name: "Lifebinder", cost: 2400, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Intelligence': '60', 'Max Health': '300', 'Health Regen': '3' }, image: getItemImage(/*ID*/), passive: 'On Use: Fire a Projectile that deals 60 (+8 per Level) Magical Damage. Marks enemy Gods for 6s. First ally to damage a Marked target: +60 (+8 per Level) Heal, +60 (+8 per Level) Shield. Consumes the Mark. Cooldown: 20s. You can own up to 3 active items at once.' },
		{ id: 'shield-splitter', name: "Shield Splitter", cost: 2400, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Physical Protection': '25', 'Magical Protection': '20', 'Strength': '40' }, image: getItemImage(/*ID*/), passive: 'On Use: Fire a projectile 11.2m forward. +40 (+5 per Level) True Damage. If an enemy is Shielded: -65% Shield, You gain a Shield equal to the amount of Shield reduced. Cooldown: 15s. You can own up to 3 active items at once.' },
		{ id: 'golden-blade', name: "Golden Blade", cost: 2450, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Strength': '30', 'Max Health': '200', 'Attack Speed': '20%' }, image: getItemImage(/*ID*/), passive: 'Attacks deal bonus Physical Damage. Damage = +20 + +15% of your Item Protections. Damages all Enemies within 2.5m.' },
		{ id: 'eye-of-the-storm', name: "Eye of the Storm", cost: 2500, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Strength': '25', 'Magical Protection': '35', 'Max Health': '200' }, image: getItemImage(/*ID*/), passive: 'On Use: Toggle Vortex around you. Pulls enemies toward you. Deals 6% of your Max Health to yourself as Magical Damage. Automatically deactivates at 200 Health. You can own up to 3 active items at once.' },
		{ id: 'helm-of-radiance', name: "Helm of Radiance", cost: 2500, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Intelligence': '65', 'Physical Protection': '35' }, image: getItemImage(/*ID*/), passive: 'Take Physical Damage: +7 Physical Protection for 6s. Stacks up to 4 times.' },
		{ id: 'gem-of-isolation', name: "Gem of Isolation", cost: 2500, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Intelligence': '50', 'Max Health': '250' }, image: getItemImage(/*ID*/), passive: 'Damaging Ability Hit: 15% Slow. The Slow lasts for 2s.' },
		{ id: 'brawlers-beat-stick', name: "Brawler's Beat Stick", cost: 2550, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Physical Protection': '15', 'Magical Protection': '15' }, image: getItemImage(/*ID*/), passive: 'Adaptive Stat: +40 Strength or +55 Intelligence (based on highest item stat). If no God damage taken/dealt in last 5s: +75% bonus of above Stat for 4s on damage dealt. If damaged by a God, instead: +20 Physical and Magical Protections. If enemy within 7.2m uses a Healing Ability: Gain both effects.' },
		{ id: 'runeforged-hammer', name: "Runeforged Hammer", cost: 2550, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Strength': '45', 'Max Health': '350', 'Health Regen': '3' }, image: getItemImage(/*ID*/), passive: 'Hard Crowd Control a God: Mark them with a Rune for 5s. Attack to forge the Rune, dealing +50 (+65% of your Item Protections) as Magical Damage. Cooldown: 30s. Hard Crowd Control a God: -6s Item Cooldown.' },
		{ id: 'eye-of-erebus', name: "Eye of Erebus", cost: 2600, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Max Health': '250', 'Cooldown Rate': '15' }, image: getItemImage(/*ID*/), passive: 'Adaptive Stat: +35 Strength or +50 Intelligence (based on highest item stat). On Use: Spawn a Watchful Eye that lasts 40s. Enemy enters range: Fires a seeking projectile: Magical Damage equal to 15% of Enemy Max Health, +25% Slow for 1.5s. Cooldown: 60s. During Moonlight Phase: Each time you deal damage to a god: -2s Cooldown of this item (Once per target, per Attack or Ability). You can own up to 3 active items at once.' },
		{ id: 'void-shield', name: "Void Shield", cost: 2600, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Strength': '25', 'Physical Protection': '30', 'Max Health': '150' }, image: getItemImage(/*ID*/), passive: 'Enemies within 8.8m: -10% Physical Protection. Range Scaling Debuff: +50% at Close Range, -50% at Maximum Range.' },
    { id: 'sanguine-lash', name: "Sanguine Lash", cost: 2650, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Magical Protection': '30', 'Strength': '35', 'Lifesteal': '5%' }, image: getItemImage(/*ID*/), passive: 'Enemies Within 4m: -0.75% Health (Max 200) as Physical Damage per 1s. +1% for every 10% Lifesteal. On Use: +5% Lifesteal for 4s, Now damages every 0.33s for 4s. Cooldown: 40s.' },
		{ id: 'shifters-shield', name: "Shifter's Shield", cost: 2650, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Physical Protection': '15', 'Magical Protection': '15', 'Max Health': '300' }, image: getItemImage(/*ID*/), passive: 'Over 75% Health: +45 Strength or +55 Intelligence (whichever is higher). Under 75% Health: +20 Physical and Magical Protection.' },
		{ id: 'void-stone', name: "Void Stone", cost: 2650, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Intelligence': '40', 'Magical Protection': '35', 'Max Health': '150' }, image: getItemImage(/*ID*/), passive: 'Enemies Within 8.8m: -10% Magical Protection. Range Scaling Debuff: +50% at Close Range, -50% at Maximum Range.' },
		{ id: 'tritons-conch', name: "Triton's Conch", cost: 2700, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Strength': '25', 'Intelligence': '40', 'Max Health': '250' }, image: getItemImage(/*ID*/), passive: 'You and allies within 8.8m: +10 (+0.5 per Level) Strength, +10 (+1 per Level) Intelligence.' },
		{ id: 'helm-of-darkness', name: "Helm of Darkness", cost: 2700, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Intelligence': '40', 'Physical Protection': '20', 'Magical Protection': '25' }, image: getItemImage(/*ID*/), passive: 'On Use: Become Stealthed and pass through players and walls for 6s. Cannot use while Casting. Cooldown: 90s. During Moonlight Phase: While Stealthed: +15% Movement Speed. Pass through an enemy god: Physical Damage equal to 15% of your Max Health. You can own up to 3 active items at once.' },
		{ id: 'sphere-of-negation', name: "Sphere of Negation", cost: 2750, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Magical Protection': '70', 'Intelligence': '40' }, image: getItemImage(/*ID*/), passive: 'Gain +2.5% Max Health Magical Shield every 3s, up to a maximum of +15% Max Health.' },
		{ id: 'wish-granting-pearl', name: "Wish-Granting Pearl", cost: 3550, tier: 3, type: 'Item', category: 'Hybrid', stats: { 'Intelligence': '120', 'Max Health': '425', 'Max Mana': '200' }, image: getItemImage(/*ID*/), passive: '' },
];
