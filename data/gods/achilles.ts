...
export const ACHILLES: God = {
  ...
  videoGuideUrl: 'https://www.youtube.com/watch?v=MQJTU3mQsNY&list=PLc3QYpLqM0tZIXDctOlabeD-4CroUPZJI&index=37',
  goodAgainst: [],
  badAgainst: [],
  levelingOrder: [],
  statsByLevel: [
    ...
    stances: [
      ...
      },
      {
        ...
        statBonuses: [
          ...
          { stat: 'movementSpeed', base: 1.25, perLevel: 0.25, isPercent: true },
        ],
        abilityEffects: [
