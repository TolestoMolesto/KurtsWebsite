...
export const Footer: React.FC = () => {
  return (
    <div className="relative w-full z-10 mt-auto">
      <footer className="w-full bg-slate-950/80 backdrop-blur-md py-6 relative border-t border-white/5">
        {/* Holiday Wreath Decoration */}
        <div className="absolute -top-8 left-1/2 -translate-x-1/2 text-5xl z-20 animate-pulse-slow filter drop-shadow-lg">
          🎄
        </div>
        <div className="container mx-auto px-4 max-w-7xl">
          ...
          <div className="mt-4 pt-4 border-t border-slate-900 text-center">
            <p className="text-[9px] text-slate-600 flex items-center justify-center gap-1">
              Made with <Heart size={8} className="text-red-500 fill-red-500 animate-pulse-slow" /> for the Smite community. Not affiliated with Hi-Rez Studios.
            </p>
            <p className="text-[8px] text-slate-700 mt-1 flex items-center justify-center gap-1">
              Happy Holidays! 🎁 May your builds be legendary ⚔️
            </p>
          </div>
        </div>
      </footer>
